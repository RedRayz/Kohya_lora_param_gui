namespace Kohya_lora_trainer
{
    partial class FormUtils
    {
        ...
        private void InitializeComponent()
        {
            ...
            toolTip1.SetToolTip(cbxUseLatestTorch, "Torch 2.6(CUDA12.4)の代わりにTorch 2.8(CUDA12.8)をインストールする\r\nNVIDIA RTX 50シリーズ使用中ならチェックつける");
            ...
            cbxPythonVersion.Items.AddRange(new object[] { "3.10", "3.11", "3.12" });
