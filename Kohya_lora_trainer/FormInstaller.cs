...
namespace Kohya_lora_trainer
{
    public partial class FormInstaller : Form
    {
        ...
        private void RunInstall(string path)
        {
            ...
            sb.Append(@" && git clone https://github.com/kohya-ss/sd-scripts.git && cd sd-scripts && python -m venv venv && .\venv\Scripts\activate && pip3 install torch torchvision --index-url https://download.pytorch.org/whl/cu121 && pip install bitsandbytes==0.41.1 --prefer-binary --extra-index-url=https://jllllll.github.io/bitsandbytes-windows-webui && pip install --upgrade -r requirements.txt && pip install --pre -U xformers && ");
