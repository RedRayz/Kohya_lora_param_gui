...
namespace Kohya_lora_trainer
{
    public partial class FormInstaller : Form
    {
        ...
        private void RunInstall(string path)
        {
            ...
            sb.Append(@" && git clone https://github.com/kohya-ss/sd-scripts.git && cd sd-scripts && python -m venv venv && .\venv\Scripts\activate && pip3 install torch torchvision torchaudio --index-url https://download.pytorch.org/whl/cu118 && pip install --upgrade -r requirements.txt && pip install --pre -U xformers && copy /y .\bitsandbytes_windows\*.dll .\venv\Lib\site-packages\bitsandbytes\ && copy /y .\bitsandbytes_windows\cextension.py .\venv\Lib\site-packages\bitsandbytes\cextension.py && copy /y .\bitsandbytes_windows\main.py .\venv\Lib\site-packages\bitsandbytes\cuda_setup\main.py && ");
