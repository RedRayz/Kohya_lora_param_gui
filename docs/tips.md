...
sd3ブランチ限定になるが、AdamWScheduleFreeもあり。スケジューラーはconstant_with_warmupでLRは0.0004でも過学習や発散を起こさない。
...
LoRA+やScheduleFreeなら1000-1500ステップがいい感じ。
...
答えはNO。小さいほど教師画像に近いこと(=過学習)を意味するので基本的にあてにならない。コピー機のような少数の画像でやる時以外はlossが減少しなくても問題なし。
